...
module.exports = function(opts){
    ...
    if (!_.isString(opts.dbtype) || !_.isString(opts.base_url) || !_.isFunction(opts.req2params)) throw new Error("Must initialise Windshaft with a database type, base URL and req2params function");
    ...
    app.get(app.base_url + '/style', function(req, res){
		...
		// Specify dbtype in Windshaft Config is 
		req.params.dbtype = opts.dbtype;
		req.params.geom_type = opts.geom_type;
